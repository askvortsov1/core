...
<form method="post">
    ...
    <p id="sharedHostingWarning" style="display:none">We noticed you're running your Flarum installation on the /public/ path. If this is what you want, no worries! But if you're on shared hosting and would like to run flarum without a subdirectory, check the following box.</p>

    <div class="FormGroup" id="sharedHostingOptions" style="display:none">
        <div class="FormField">
            <label>Shared Hosting Mode?</label>
            <input type="checkbox" name="switchSkeletonToShared">
        </div>
    </div>
...
<script>
    ...
    if (window.location.pathname.includes("public")) {
        $('#sharedHostingOptions').removeAttr("style");
        $('#sharedHostingWarning').removeAttr("style");
    }
</script>